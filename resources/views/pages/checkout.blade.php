            ...
            <div class="container">
                    ...
                    <div class="attendee">
                        ...
                        <tr>
                                ...
                                <td class="align-middle">
                                    {{\Carbon\Carbon::createFromDate($detail->passport) >
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center"> No Visitorr</td>
                            </tr>
                        @endforelse
                        </tbody>
                        </table>
                ...
                <div class="col-lg-4">
                    ...
                    <table class="trip-informations">
                        ...
                        <td width="50%" class="text-right">$ {{$item->transactional_total}},00</td>
                        </tr>
                        <tr>
                    ...
                    <p class="payment-instructions">
                        You will be redirected to another page tp pay using gopay
                    </p>
                    <img src="{{asset('backend/img/undraw_posting_photo.svg')}}" class="w-50" alt="">
